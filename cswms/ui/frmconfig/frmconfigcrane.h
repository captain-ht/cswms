#ifndef FRMCONFIGCRANE_H
#define FRMCONFIGCRANE_H
...
namespace Ui {
class frmConfigCrane;
}

class frmConfigCrane : public QWidget
{
    Q_OBJECT

public:
    explicit frmConfigCrane(QWidget *parent = nullptr);
    ~frmConfigCrane();
