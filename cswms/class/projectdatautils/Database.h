...
public:
    explicit Database(const QString &dbnamePrj = "xpen",
                      const QString &dbnameHis = "HisData",
    ...
    virtual int createTable(QSqlQuery query,
                            const QString &table,
    ...
    int getRowCount(QSqlQuery query, const QString &tableName, const QString &expr);
