...
exists($$depfile) {
    ...
    isEmpty(QTC_PLUGIN_NAME): \
        error("QTC_PLUGIN_NAME is empty. Maybe you meant $$depfile to create $$basename(depfile)?")
}
...
defineReplace(dependencyName) {
    ...
    for(dir, QTC_PLUGIN_DIRS) {
        exists($$dir/$$1/$$1/$${1}_dependencies.pri) {
            dependencies_file = $$dir/$$1/$$1/$${1}_dependencies.pri
            break()
        }
    }
