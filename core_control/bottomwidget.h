...
private:
    ...
    QLabel *labTitle;               //软件标题变量
    QLabel *labCopyright;           //版权所有变量
    QLabel *labUser;                //当前用户变量
    QLabel *labLive;                //已运行时间变量
    QLabel *labDateTime;            //当前时间变量

    bool labTitleVisible;           //标题变量是否可见
    bool labCopyrightVisible;       //版权所有变量是否可见
    bool labUserVisible;            //当前用户变量是否可见
    bool labLiveVisible;            //已运行时间变量是否可见
    bool labDateTimeVisible;        //当前时间变量是否可见
