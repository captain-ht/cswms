...
#define CM4X_MAX    (100)
    ...
    QList<QVector<IOTag*>> vecCm0xList;
    QList<QVector<IOTag*>> vecCm1xList;
    QList<QVector<IOTag*>> vecCm3xList;
    QList<QVector<IOTag*>> vecCm4xList;
    ...
    QVector<IOTag*> vecCm0x_temp;
    QVector<IOTag*> vecCm1x_temp;
    QVector<IOTag*> vecCm3x_temp;
    QVector<IOTag*> vecCm4x_temp;
    ...
    for (int i = 0; i < listRead.size(); ++i) {
        ...
        TModbus_CPUMEM cm = getCpuMem(pTag->GetRegisterArea());
        int add = pTag->GetDeviceAddress();

        switch(cm) {
        case CM_0x:
            if(addCm0x != add and vecCm0x.size() > 0){
                vecCm0xList.append(vecCm0x);
                vecCm0x.clear();
            }
            vecCm0x.append(pTag);
            addCm0x = add;
            break;
        case CM_1x:
            if(addCm1x != add and vecCm1x.size() > 0){
                vecCm1xList.append(vecCm1x);
                vecCm1x.clear();
            }
            vecCm1x.append(pTag);
            addCm1x = add;
            break;
        case CM_3x:
            if(addCm3x != add and vecCm3x.size() > 0){
                vecCm3xList.append(vecCm3x);
                vecCm3x.clear();
            }
            vecCm3x.append(pTag);
            addCm3x = add;
            break;
        case CM_4x:
            if(addCm4x != add and vecCm4x.size() > 0){
                vecCm4xList.append(vecCm4x);
                vecCm4x.clear();
            }
            vecCm4x.append(pTag);
            addCm4x = add;
    ...
    int blockNum = 0;
    for(int ii = 0; ii < vecCm0xList.count(); ++ii){
        vecCm0x = vecCm0xList.at(ii);
        int iMin = CM0X_MAX;
        int iMax = 0;
        ...
        for(int i=0; i< iRange; i++) {
            ...
            QString szTagId = QString("block_0x_%1").arg(blockNum++, 4, 16, QChar('0'));
    ...
    blockNum = 0;
    for(int ii = 0; ii < vecCm1xList.count(); ++ii){
        vecCm1x = vecCm1xList.at(ii);
        int iMin = CM1X_MAX;
        int iMax = 0;
        ...
        for(int i=0; i< iRange; i++) {
            ...
            QString szTagId = QString("block_1x_%1").arg(blockNum++, 4, 16, QChar('0'));
            int iLen = iMax - iStartAddr + 1;
    ...
    blockNum = 0;
    for(int ii = 0; ii < vecCm3xList.count(); ++ii){
        vecCm3x = vecCm3xList.at(ii);
        int iMin = CM3X_MAX;
        int iMax = 0;
        ...
        for(int i=0; i< iRange; i++) {
            ...
            QString szTagId = QString("block_3x_%1").arg(blockNum++, 4, 16, QChar('0'));
    ...
    blockNum = 0;
    for(int ii = 0; ii < vecCm4xList.count(); ++ii){
        vecCm4x = vecCm4xList.at(ii);
        int iMin = CM4X_MAX;
        int iMax = 0;
        ...
        for(int i=0; i< iRange; i++) {
            ...
            QString szTagId = QString("block_4x_%1").arg(blockNum++, 4, 16, QChar('0'));
            int iLen = iMax - iStartAddr;
