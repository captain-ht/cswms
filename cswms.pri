!isEmpty(CSWMS_PRI_INCLUDED):error("cswms.pri already included")
CSWMS_PRI_INCLUDED = 1
...
IDE_APP_PATH = $$clean_path($$IDE_BUILD_TREE/../cswmsBin)
...
INCLUDEPATH += \
    $$IDE_SOURCE_TREE/core_port \
    $$IDE_SOURCE_TREE/core_tag \
    $$IDE_SOURCE_TREE/core_public \
    $$IDE_SOURCE_TREE/core_vendor \
