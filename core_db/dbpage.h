 ...
 * 4. 可设置当前页/总页数/总记录数/每页记录数/查询用时变量页
...
private:
    ...
    QLabel *labPageTotal;       //总页数变量
    QLabel *labPageCurrent;     //当前页变量
    QLabel *labRecordsTotal;    //总记录数变量
    QLabel *labRecordsPerpage;  //每页记录数变量
    QLabel *labSelectTime;      //显示查询用时变量
