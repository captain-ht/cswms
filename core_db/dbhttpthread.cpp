...
QMap<QString, QString> DbHttpThread::getTables2()
{
    ...
    tables.insert("DeviceInfo1", "DeviceID,DeviceNumber,DeviceaPara1,DeviceaPara2,DeviceaPara3,DeviceaPara4,DeviceaPara5,DeviceaPara6,DeviceaPara7,DeviceaPara8,DeviceaPara9,DeviceaPara10,DeviceMark");
    return tables;
}
